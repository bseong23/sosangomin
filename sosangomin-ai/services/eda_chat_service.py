...
class EdaChatService:
    def __init__(self):
        ...
        2. 마크다운 문단으로 간결하게 설명하세요.
        3. 데이터가 보여주는 주요 패턴이나 인사이트를 직관적으로 설명하세요.
        4. 사업주나 매장 운영자가 실제로 활용할 수 있는 방식으로 설명하세요.
        5. "## 차트별 설명", "## 전체 요약" 같은 표시를 사용하지 말고 바로 설명을 시작하세요.
        """
    ...
    async def generate_chart_summary(self, chart_type: str, data: Any) -> str:
        ...
        try:
            chart_prompts = {
                ...
                "temperature_sales": "기온별 매출 데이터입니다: {}. 기온에 따라 매출이 어떻게 달라지는지 간단히 설명해주세요.",
                
                "weather_sales": "날씨별 매출 데이터입니다: {}. 맑은 날과 비/눈 오는 날의 매출 차이를 쉽게 설명해주세요.",
