...
#     while True:
#         await resident_population_service.update_population_data()
#         await asyncio.sleep(60 * 60 * 24 * 90)  # 90일 (3개월)마다

# # 유동 인구 스케줄러
# async def schedule_floating_population_updates():
#     while True:
#         await floating_population_service.update_population_data()
#         await asyncio.sleep(60 * 60 * 24)  # 매일

# # 직장 인구 스케줄러
# async def schedule_working_population_updates():
#     while True:
#         await working_population_service.update_population_data()
#         await asyncio.sleep(60 * 60 * 24 * 30)  # 매달